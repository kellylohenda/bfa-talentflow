...
const PROGRAMS = [
  {
    ...
    name: 'Futuro BFA',
    desc: 'O programa-bandeira para recém-licenciados. Rotação por 4 departamentos, formação técnica intensiva e contrato directo no fim do percurso.',
  ...
  },
  {
    ...
    desc: 'Para os melhores estudantes angolanos a frequentar mestrados em escolas de referência na Europa. Cobertura integral de propinas e custo de vida.',
  ...
  },
  {
    ...
    name: 'Bolsa Nacional',
    desc: 'Apoio integral a estudantes em universidades angolanas, com foco em equidade territorial e inclusão de talento das províncias.',
  ...
  },
  {
    ...
    name: 'Programa Liderança+',
    desc: 'Para colaboradores de alto potencial já no BFA com 2–5 anos de casa. Formação executiva e exposição directa ao Comité de Direcção.',
...
const FAQS = [
  { q: 'Quem pode candidatar-se?', a: 'Cidadãos angolanos com licenciatura concluída ou em fase final, idade até 28 anos para o Futuro BFA, e até 32 anos para a Bolsa Internacional. Os restantes programas têm critérios específicos detalhados em cada página.' },
  ...
  { q: 'Posso candidatar-me a mais que um programa?', a: 'Sim, podes indicar até dois programas por ordem de preferência no mesmo formulário. A avaliação é integrada e poupa-te tempo.' },
  { q: 'O que cobre a Bolsa Internacional?', a: 'Propinas integrais, subsídio mensal de subsistência (variável conforme cidade), alojamento, viagens anuais de regresso a Luanda e seguro de saúde internacional. A bolsa exige uma cláusula de retorno de 5 anos no BFA.' },
  { q: 'Há vagas para estudantes das províncias?', a: 'Sim. A Bolsa Nacional reserva 30% das vagas para estudantes inscritos em universidades fora de Luanda, com critérios de equidade socioeconómica.' },
  { q: 'Como são protegidos os meus dados pessoais?', a: 'Cumprimos integralmente a Lei 22/11 da Agência de Protecção de Dados (APD). Os dados são encriptados e tens direito a aceder, corrigir ou solicitar a sua eliminação a qualquer momento.' },
]
    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero h1 { font-size: clamp(44px,6.2vw,84px); line-height: 0.98; letter-spacing: -0.04em; font-weight: 600; }
        ...
        .prog-card { border:1px solid #E7E5E1; border-radius:12px; padding:32px; background:#fff; transition:border-color 120ms,transform 120ms; }
      ...
      <div className="pub-top">
        <div className="pub-top-inner">
          <a href="/programa" className="pub-brand">
            <div className="pub-logo">B</div>
            <div>BFA Talento <small>· Programa Futuro BFA</small></div>
          </a>
      ...
      <section className="hero">
        ...
        <div className="hero-grid">
          <div>
            <span className="pub-eyebrow">Candidaturas abertas · Edição 2026</span>
            <h1>O teu percurso<br/>começa <em>aqui.</em></h1>
            <p>O Programa Futuro BFA prepara a próxima geração de líderes da banca angolana com formação académica, mentoria sénior e experiência prática nas áreas mais estratégicas do banco.</p>
            <div className="hero-actions">
              <Link href="/candidatura" className="pub-cta pub-cta-primary">Iniciar candidatura</Link>
              <a href="#programas" className="pub-cta" style={{ background: '#fff', color: '#1A1A1A', border: '1px solid #E7E5E1' }}>Ver programas</a>
            </div>
            <div className="hero-meta">
              <div><div className="num">247</div><div className="lbl">Talentos activos</div></div>
              <div><div className="num">11</div><div className="lbl">Países</div></div>
              <div><div className="num">87%</div><div className="lbl">Taxa de retenção</div></div>
            </div>
          </div>
          <div className="hero-collage">
            <div className="hc-card hc-photo-1">
              ...
              <span className="label">Lwini Capemba · Trainee Y1 · Banca Empresas</span>
            </div>
            ...
            <div className="hc-stat">
              ...
              <div className="lbl">Investidos · 2025</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="numbers-strip">
        <div className="numbers-grid">
          {[['2.140+','Candidaturas em 2025'],['73','Novos seleccionados'],['42','Universidades parceiras'],['4,2x','ROI médio · 5 anos']].map(([big,lbl])=>(
            <div key={lbl} className="num-item"><div className="big">{big}</div><div className="lbl">{lbl}</div></div>
          ))}
        </div>
      </section>
      ...
      <section className="pub-section" id="programas">
        <div className="pub-container">
          <span className="pub-eyebrow">Quatro caminhos</span>
      ...
      <section className="pub-section process-bg" id="processo">
        <div className="pub-container">
          <span className="pub-eyebrow">Quatro etapas</span>
        ...
        <div className="t-grid">
          <div className="t-portrait">
            ...
            <div className="t-badge">
              <b>Lwini Capemba</b>
              Trainee Y1 · Banca de Empresas
            </div>
          </div>
          <div>
            <blockquote>
              Entrei há oito meses e já trabalhei em três áreas diferentes. O que me surpreendeu não foi a formação — foi a confiança que põem em nós desde o primeiro dia.
            </blockquote>
      ...
      <section className="cta-banner">
        ...
        <p>Candidaturas para a edição 2026 abertas até 30 de Junho. 15 minutos para iniciar.</p>
        <Link href="/candidatura" className="pub-cta">Iniciar candidatura →</Link>
      </section>
      ...
      <footer className="pub-footer">
        <div className="pub-footer-inner">
          ...
          <div>
            <h5>Programas</h5>
            <ul>
              {['Futuro BFA','Bolsa Internacional','Bolsa Nacional','Liderança+'].map(p=><li key={p}><a href="#">{p}</a></li>)}
            </ul>
          </div>
          <div>
            <h5>Recursos</h5>
          ...
          <div>
            ...
            <ul>
              ...
              <li>+244 222 000 000</li>
              <li>Sede BFA · Luanda</li>
            </ul>
          </div>
        </div>
        <div className="pub-footer-bottom">
          <span>© 2026 Banco de Fomento Angola. Todos os direitos reservados.</span>
