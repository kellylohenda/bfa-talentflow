...
export const volunteers: Volunteer[] = [
  { id: 'V-001', nome: 'Ana Paula Kiala',        email: 'apkiala@bfa.ao',      tel: '+244 912 100 001', profissao: 'Gestora de Conta',      instituicao: 'BFA',                           provincia: 'Luanda',    local: 'Ingombota',       dataInscricao: '2024-02-10', status: 'activo',     areaActuacao: 'educacao', totalHoras: 48 },
  { id: 'V-002', nome: 'Carlos Ndombe',          email: 'cndombe@bfa.ao',      tel: '+244 912 100 002', profissao: 'Analista de Risco',      instituicao: 'BFA',                           provincia: 'Luanda',    local: 'Maianga',         dataInscricao: '2024-03-05', status: 'activo',     areaActuacao: 'saude',    totalHoras: 36 },
  { id: 'V-003', nome: 'Felícia Bumba',          email: 'fbumba@gmail.com',    tel: '+244 912 100 003', profissao: 'Médica',                 instituicao: 'Hospital Josina Machel',        provincia: 'Luanda',    local: 'Rangel',          dataInscricao: '2024-01-20', status: 'activo',     areaActuacao: 'saude',    totalHoras: 64 },
  { id: 'V-004', nome: 'Isac Tchilemba',         email: 'itchilemba@gmail.com',tel: '+244 912 100 004', profissao: 'Professor',              instituicao: 'Escola Sec. Patrice Lumumba',  provincia: 'Luanda',    local: 'Sambizanga',      dataInscricao: '2024-04-12', status: 'activo',     areaActuacao: 'educacao', totalHoras: 52 },
  { id: 'V-005', nome: 'Lurdes Cassinda',        email: 'lcassinda@bfa.ao',    tel: '+244 912 100 005', profissao: 'Directora de Marketing', instituicao: 'BFA',                           provincia: 'Luanda',    local: 'Alvalade',        dataInscricao: '2023-11-08', status: 'activo',     areaActuacao: 'cultura',  totalHoras: 88 },
  { id: 'V-006', nome: 'Manuel Songo',           email: 'msongo@ucan.edu.ao',  tel: '+244 912 100 006', profissao: 'Engenheiro Ambiental',   instituicao: 'Universidade Católica Angola',  provincia: 'Luanda',    local: 'Talatona',        dataInscricao: '2024-02-28', status: 'activo',     areaActuacao: 'ambiente', totalHoras: 40 },
  { id: 'V-007', nome: 'Palmira Dala',           email: 'pdala@gmail.com',     tel: '+244 912 100 007', profissao: 'Assistente Social',      instituicao: 'Ministério da Acção Social',    provincia: 'Luanda',    local: 'Cazenga',         dataInscricao: '2024-05-15', status: 'activo',     areaActuacao: 'social',   totalHoras: 24 },
  { id: 'V-008', nome: 'Ricardo Catata',         email: 'rcatata@bfa.ao',      tel: '+244 912 100 008', profissao: 'Técnico de TI',          instituicao: 'BFA',                           provincia: 'Benguela',  local: 'Centro',          dataInscricao: '2024-06-01', status: 'activo',     areaActuacao: 'educacao', totalHoras: 20 },
  { id: 'V-009', nome: 'Sofia Mavungo',          email: 'smavungo@gmail.com',  tel: '+244 912 100 009', profissao: 'Nutricionista',          instituicao: 'Clínica Girassol',              provincia: 'Luanda',    local: 'Viana',           dataInscricao: '2024-03-18', status: 'inactivo',   areaActuacao: 'saude',    totalHoras: 16 },
  { id: 'V-010', nome: 'Tomé Quissama',          email: 'tquissama@uan.ao',    tel: '+244 912 100 010', profissao: 'Estudante de Direito',   instituicao: 'Universidade Agostinho Neto',   provincia: 'Luanda',    local: 'Samba',           dataInscricao: '2024-07-20', status: 'activo',     areaActuacao: 'social',   totalHoras: 32 },
  { id: 'V-011', nome: 'Verônica Lopes',         email: 'vlopes@bfa.ao',       tel: '+244 912 100 011', profissao: 'Contabilista',           instituicao: 'BFA',                           provincia: 'Luanda',    local: 'Miramar',         dataInscricao: '2023-09-14', status: 'desistente',  areaActuacao: 'educacao', totalHoras: 12 },
  { id: 'V-012', nome: 'Xavier Ngola',           email: 'xngola@gmail.com',    tel: '+244 912 100 012', profissao: 'Arquitecto',             instituicao: 'Studio Ngola Arquitectos',      provincia: 'Huambo',    local: 'Centro',          dataInscricao: '2024-08-05', status: 'activo',     areaActuacao: 'cultura',  totalHoras: 28 },
  { id: 'V-013', nome: 'Yara Domingos',          email: 'ydomingos@bfa.ao',    tel: '+244 912 100 013', profissao: 'Advogada',               instituicao: 'BFA',                           provincia: 'Luanda',    local: 'Kilamba',         dataInscricao: '2024-01-30', status: 'activo',     areaActuacao: 'social',   totalHoras: 44 },
  { id: 'V-014', nome: 'Zacarias Bula',          email: 'zbula@gmail.com',     tel: '+244 912 100 014', profissao: 'Biólogo',                instituicao: 'Instituto Nacional de Recursos', provincia: 'Cabinda',   local: 'Centro',          dataInscricao: '2024-04-25', status: 'activo',     areaActuacao: 'ambiente', totalHoras: 56 },
  { id: 'V-015', nome: 'Adelina Weba',           email: 'aweba@gmail.com',     tel: '+244 912 100 015', profissao: 'Jornalista',             instituicao: 'Jornal de Angola',              provincia: 'Luanda',    local: 'Rocha Pinto',     dataInscricao: '2024-09-10', status: 'desistente',  areaActuacao: 'cultura',  totalHoras: 8  },
]
