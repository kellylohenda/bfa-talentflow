import type { Program, Talent, Application, Payment, Mentor, GeoPoint, NineBoxItem, ActivityItem, Notification, BolseiroPayment, Task, Absence, Workflow, Stage } from '@/types'
