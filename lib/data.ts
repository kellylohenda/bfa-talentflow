import type { Program, Talent, Application, Payment, Mentor, GeoPoint, NineBoxItem, ActivityItem, Notification, BolseiroPayment, Task, Absence, Workflow, Stage, Volunteer, VolunteerActivity, HoursEntry, Rotation, Presenca, SessaoBolseiro, Evento } from '@/types'
...
export const talents: Talent[] = [
  { id: 'T-1042', name: 'Lwini Capemba',         gender: 'F', program: 'fbfa', kind: 'estagiario', university: 'Universidade Agostinho Neto',    city: 'Luanda',    country: 'Angola',        course: 'Economia',                year: 'Trainee Y1', gpa: 17.2, status: 'active',     dept: 'Banca de Empresas', mentor: 'Edmilson Cardoso', stipend: 380000,  startDate: '2024-09-01', perf: 92, potential: 'alto',  riskScore: 0.12, lastReport: '2026-04-22' },
  { id: 'T-1043', name: 'Joaquim Tchindemba',    gender: 'M', program: 'bif',  kind: 'bolseiro',   university: 'Nova SBE',                       city: 'Lisboa',    country: 'Portugal',      course: 'Mestrado Finanças',        year: '2º ano',     gpa: 16.8, status: 'active',     dept: '—',                 mentor: 'Sofia Mendes',     stipend: 1850000, startDate: '2024-09-15', perf: 88, potential: 'alto',  riskScore: 0.15, lastReport: '2026-04-15' },
  { id: 'T-1044', name: 'Esperança Quimbamba',   gender: 'F', program: 'bnac', kind: 'bolseiro',   university: 'Universidade Católica de Angola', city: 'Luanda',   country: 'Angola',        course: 'Gestão',                  year: '3º ano',     gpa: 14.5, status: 'delayed',    dept: '—',                 mentor: 'Domingos Vieira',  stipend: 220000,  startDate: '2023-10-02', perf: 71, potential: 'médio', riskScore: 0.42, lastReport: '2026-02-10' },
  { id: 'T-1045', name: 'Yuran Bumba',           gender: 'M', program: 'fbfa', kind: 'estagiario', university: 'Universidade Agostinho Neto',    city: 'Luanda',    country: 'Angola',        course: 'Engenharia Informática',  year: 'Trainee Y2', gpa: 16.1, status: 'active',     dept: 'TI / Sistemas',     mentor: 'Patrícia Lopes',   stipend: 420000,  startDate: '2023-09-01', perf: 84, potential: 'alto',  riskScore: 0.20, lastReport: '2026-04-20' },
  { id: 'T-1046', name: 'Domingas Kassinda',     gender: 'F', program: 'mest', kind: 'bolseiro',   university: 'Universidade do Porto',          city: 'Porto',     country: 'Portugal',      course: 'Mestrado Contabilidade',  year: '1º ano',     gpa: 17.6, status: 'active',     dept: '—',                 mentor: 'José Almeida',     stipend: 1620000, startDate: '2025-09-12', perf: 94, potential: 'alto',  riskScore: 0.08, lastReport: '2026-04-28' },
  { id: 'T-1047', name: 'Adélio Sebastião',      gender: 'M', program: 'bnac', kind: 'bolseiro',   university: 'Universidade Lusíada de Angola', city: 'Luanda',   country: 'Angola',        course: 'Matemática Aplicada',     year: '4º ano',     gpa: 13.2, status: 'risk',       dept: '—',                 mentor: 'Lina Cazimba',     stipend: 240000,  startDate: '2022-09-20', perf: 58, potential: 'baixo', riskScore: 0.78, lastReport: '2026-01-18' },
  { id: 'T-1048', name: 'Kiala Domingos',        gender: 'M', program: 'lid',  kind: 'bolseiro',   university: 'Universidade Agostinho Neto',    city: 'Luanda',    country: 'Angola',        course: 'Pós-graduação Liderança', year: 'Y1',         gpa: 18.0, status: 'active',     dept: 'Banca Privada',     mentor: 'Edmilson Cardoso', stipend: 540000,  startDate: '2025-02-03', perf: 96, potential: 'alto',  riskScore: 0.06, lastReport: '2026-04-30' },
  { id: 'T-1049', name: 'Nzinga Matondo',        gender: 'F', program: 'bif',  kind: 'bolseiro',   university: 'ISCTE-IUL',                      city: 'Lisboa',    country: 'Portugal',      course: 'Mestrado Banca & Seguros',year: '2º ano',     gpa: 16.4, status: 'active',     dept: '—',                 mentor: 'Sofia Mendes',     stipend: 1780000, startDate: '2024-09-10', perf: 86, potential: 'alto',  riskScore: 0.18, lastReport: '2026-04-12' },
  { id: 'T-1050', name: 'Fernando Ngoma',        gender: 'M', program: 'fbfa', kind: 'estagiario', university: 'Universidade Católica de Angola', city: 'Luanda',   country: 'Angola',        course: 'Gestão Financeira',       year: 'Trainee Y1', gpa: 15.4, status: 'onboarding', dept: 'Risco de Crédito',  mentor: 'Patrícia Lopes',   stipend: 380000,  startDate: '2026-03-01', perf: 78, potential: 'médio', riskScore: 0.22, lastReport: '2026-04-05' },
  { id: 'T-1051', name: 'Carla Bunga',           gender: 'F', program: 'bif',  kind: 'bolseiro',   university: 'HEC Paris',                      city: 'Paris',     country: 'França',        course: 'MBA',                     year: '1º ano',     gpa: 17.9, status: 'active',     dept: '—',                 mentor: 'José Almeida',     stipend: 2640000, startDate: '2025-09-20', perf: 95, potential: 'alto',  riskScore: 0.10, lastReport: '2026-04-25' },
  { id: 'T-1052', name: 'Walter Tchitangueleca', gender: 'M', program: 'bnac', kind: 'bolseiro',   university: 'Universidade Agostinho Neto',    city: 'Luanda',    country: 'Angola',        course: 'Estatística',             year: '2º ano',     gpa: 12.8, status: 'delayed',    dept: '—',                 mentor: 'Domingos Vieira',  stipend: 200000,  startDate: '2024-10-05', perf: 64, potential: 'médio', riskScore: 0.55, lastReport: '2026-02-28' },
  { id: 'T-1053', name: 'Aida Bento',            gender: 'F', program: 'fbfa', kind: 'estagiario', university: 'Universidade Agostinho Neto',    city: 'Luanda',    country: 'Angola',        course: 'Marketing & Comunicação', year: 'Trainee Y2', gpa: 16.7, status: 'active',     dept: 'Marketing',         mentor: 'Lina Cazimba',     stipend: 420000,  startDate: '2023-09-01', perf: 89, potential: 'alto',  riskScore: 0.14, lastReport: '2026-04-18' },
  { id: 'T-1054', name: 'Heitor Quitumba',       gender: 'M', program: 'mest', kind: 'bolseiro',   university: 'LSE',                            city: 'Londres',   country: 'Reino Unido',   course: 'MSc Risk & Finance',      year: '1º ano',     gpa: 17.4, status: 'active',     dept: '—',                 mentor: 'Sofia Mendes',     stipend: 3120000, startDate: '2025-09-25', perf: 91, potential: 'alto',  riskScore: 0.09, lastReport: '2026-04-22' },
  { id: 'T-1055', name: 'Beatriz Sapalo',        gender: 'F', program: 'bnac', kind: 'bolseiro',   university: 'Universidade Católica de Angola', city: 'Luanda',   country: 'Angola',        course: 'Direito Económico',       year: '4º ano',     gpa: 15.8, status: 'completed',  dept: '—',                 mentor: 'Domingos Vieira',  stipend: 0,       startDate: '2021-09-01', perf: 82, potential: 'médio', riskScore: 0.20, lastReport: '2026-03-30' },
  { id: 'T-1056', name: 'Mateus Cabuenha',       gender: 'M', program: 'fbfa', kind: 'estagiario', university: 'Universidade Agostinho Neto',    city: 'Luanda',    country: 'Angola',        course: 'Auditoria',               year: 'Trainee Y1', gpa: 15.9, status: 'active',     dept: 'Auditoria Interna', mentor: 'Patrícia Lopes',   stipend: 380000,  startDate: '2025-09-05', perf: 81, potential: 'médio', riskScore: 0.19, lastReport: '2026-04-20' },
  { id: 'T-1057', name: 'Olívia Kambamba',       gender: 'F', program: 'bif',  kind: 'bolseiro',   university: 'Universidade de São Paulo',      city: 'São Paulo', country: 'Brasil',        course: 'Mestrado Economia',       year: '2º ano',     gpa: 17.0, status: 'active',     dept: '—',                 mentor: 'José Almeida',     stipend: 1450000, startDate: '2024-08-15', perf: 87, potential: 'alto',  riskScore: 0.16, lastReport: '2026-04-10' },
  { id: 'T-1058', name: 'Alberto Massano',       gender: 'M', program: 'lid',  kind: 'bolseiro',   university: 'Universidade Agostinho Neto',    city: 'Luanda',    country: 'Angola',        course: 'Liderança Executiva',     year: 'Y2',         gpa: 17.8, status: 'hired',      dept: 'Banca de Empresas', mentor: 'Edmilson Cardoso', stipend: 0,       startDate: '2022-02-15', perf: 94, potential: 'alto',  riskScore: 0.07, lastReport: '2026-04-15' },
  { id: 'T-1059', name: 'Helga Pacavira',        gender: 'F', program: 'bnac', kind: 'bolseiro',   university: 'Universidade Lusíada de Angola', city: 'Luanda',   country: 'Angola',        course: 'Contabilidade',           year: '3º ano',     gpa: 14.0, status: 'delayed',    dept: '—',                 mentor: 'Lina Cazimba',     stipend: 220000,  startDate: '2023-10-15', perf: 70, potential: 'médio', riskScore: 0.40, lastReport: '2026-03-02' },
]

export const rotations: Rotation[] = [
  { id: 'ROT-001', talentId: 'T-1042', talentName: 'Lwini Capemba',    dept: 'Banca de Empresas',  supervisor: 'Carlos Neto',      startDate: '2024-09-01', endDate: '2024-12-31', status: 'concluida', notes: 'Excelente integração. Recomendada para continuação.' },
  { id: 'ROT-002', talentId: 'T-1042', talentName: 'Lwini Capemba',    dept: 'Risco de Crédito',   supervisor: 'Ana Viegas',       startDate: '2025-01-06', endDate: '2025-04-30', status: 'concluida', notes: 'Boa capacidade analítica.' },
  { id: 'ROT-003', talentId: 'T-1042', talentName: 'Lwini Capemba',    dept: 'Banca de Empresas',  supervisor: 'Carlos Neto',      startDate: '2025-05-01', endDate: '2026-04-30', status: 'concluida', notes: 'Y2 — preparação para integração.' },
  { id: 'ROT-004', talentId: 'T-1042', talentName: 'Lwini Capemba',    dept: 'Tesouraria',         supervisor: 'Lúcio Baptista',   startDate: '2026-05-01', endDate: '2026-08-31', status: 'activa',    notes: 'Rotação em curso.' },
  { id: 'ROT-005', talentId: 'T-1045', talentName: 'Yuran Bumba',      dept: 'TI / Sistemas',      supervisor: 'Maria Fonseca',    startDate: '2023-09-01', endDate: '2024-02-28', status: 'concluida', notes: 'Desenvolvimento back-end.' },
  { id: 'ROT-006', talentId: 'T-1045', talentName: 'Yuran Bumba',      dept: 'Operações',          supervisor: 'Pedro Coelho',     startDate: '2024-03-01', endDate: '2024-08-31', status: 'concluida', notes: 'Automação de processos.' },
  { id: 'ROT-007', talentId: 'T-1045', talentName: 'Yuran Bumba',      dept: 'TI / Sistemas',      supervisor: 'Maria Fonseca',    startDate: '2024-09-01', endDate: '2025-06-30', status: 'concluida', notes: 'Liderança de projecto.' },
  { id: 'ROT-008', talentId: 'T-1045', talentName: 'Yuran Bumba',      dept: 'Compliance',         supervisor: 'Rui Gaspar',       startDate: '2025-07-01', endDate: '2026-06-30', status: 'activa',    notes: 'Tech compliance + GDPR.' },
  { id: 'ROT-009', talentId: 'T-1050', talentName: 'Fernando Ngoma',   dept: 'Risco de Crédito',   supervisor: 'Ana Viegas',       startDate: '2026-03-01', endDate: '2026-08-31', status: 'activa',    notes: 'Onboarding — 1ª rotação.' },
  { id: 'ROT-010', talentId: 'T-1053', talentName: 'Aida Bento',       dept: 'Marketing',          supervisor: 'Joana Pires',      startDate: '2023-09-01', endDate: '2024-08-31', status: 'concluida', notes: 'Campanhas digitais e social media.' },
  { id: 'ROT-011', talentId: 'T-1053', talentName: 'Aida Bento',       dept: 'Banca de Retalho',   supervisor: 'Tomé Vieira',      startDate: '2024-09-01', endDate: '2025-04-30', status: 'concluida', notes: 'CRM e relacionamento cliente.' },
  { id: 'ROT-012', talentId: 'T-1053', talentName: 'Aida Bento',       dept: 'Marketing',          supervisor: 'Joana Pires',      startDate: '2025-05-01', endDate: '2026-06-30', status: 'activa',    notes: 'Gestão de produto.' },
  { id: 'ROT-013', talentId: 'T-1056', talentName: 'Mateus Cabuenha',  dept: 'Auditoria Interna',  supervisor: 'Filipe Santos',    startDate: '2025-09-05', endDate: '2026-03-31', status: 'concluida', notes: 'Auditoria de crédito.' },
  { id: 'ROT-014', talentId: 'T-1056', talentName: 'Mateus Cabuenha',  dept: 'Compliance',         supervisor: 'Rui Gaspar',       startDate: '2026-04-01', endDate: '2026-09-30', status: 'activa',    notes: 'Regulamentação e controlo interno.' },
]

export const applications: Application[] = [
  { id: 'A-2451', name: 'Tomás Quissanga',    program: 'fbfa', tipo: 'estagiario',   stage: 'triagem',     score: 78, source: 'LinkedIn',     appliedAt: '2026-04-28', course: 'Economia',         uni: 'UAN' },
  { id: 'A-2452', name: 'Kissila Mbumba',     program: 'fbfa', tipo: 'estagiario',   stage: 'triagem',     score: 84, source: 'Site BFA',     appliedAt: '2026-04-28', course: 'Gestão',           uni: 'UCAN' },
  { id: 'A-2453', name: 'Nelson Cassule',     program: 'bif',  tipo: 'bolseiro',     stage: 'entrevista1', score: 81, source: 'Site BFA',     appliedAt: '2026-04-25', course: 'Mestrado Fin.',    uni: 'Nova SBE' },
  { id: 'A-2454', name: 'Inês Caholo',        program: 'fbfa', tipo: 'estagiario',   stage: 'entrevista1', score: 88, source: 'Universidade', appliedAt: '2026-04-24', course: 'Matemática',       uni: 'UAN' },
  { id: 'A-2455', name: 'Pedro Bastos',       program: 'fbfa', tipo: 'estagiario',   stage: 'entrevista2', score: 91, source: 'LinkedIn',     appliedAt: '2026-04-20', course: 'Eng. Informática', uni: 'UCAN' },
  { id: 'A-2456', name: 'Eunice Bula',        program: 'bnac', tipo: 'bolseiro',     stage: 'avaliacao',   score: 86, source: 'Site BFA',     appliedAt: '2026-04-18', course: 'Contabilidade',    uni: 'Lusíada' },
  { id: 'A-2457', name: 'Vitor Sambongo',     program: 'fbfa', tipo: 'estagiario',   stage: 'avaliacao',   score: 89, source: 'Indicação',    appliedAt: '2026-04-15', course: 'Finanças',         uni: 'UCAN' },
  { id: 'A-2458', name: 'Cláudia Ngongo',     program: 'mest', tipo: 'bolseiro',     stage: 'aprovacao',   score: 93, source: 'Universidade', appliedAt: '2026-04-12', course: 'Mestrado Cont.',   uni: 'Porto' },
  { id: 'A-2459', name: 'Rui Manjate',        program: 'bif',  tipo: 'bolseiro',     stage: 'aprovacao',   score: 90, source: 'LinkedIn',     appliedAt: '2026-04-10', course: 'MBA',              uni: 'HEC Paris' },
  { id: 'A-2460', name: 'Liliana Bange',      program: 'fbfa', tipo: 'estagiario',   stage: 'oferta',      score: 92, source: 'Site BFA',     appliedAt: '2026-04-08', course: 'Economia',         uni: 'UAN' },
  { id: 'A-2461', name: 'Fábio Quitumba',     program: 'fbfa', tipo: 'estagiario',   stage: 'oferta',      score: 87, source: 'Indicação',    appliedAt: '2026-04-05', course: 'Gestão',           uni: 'UCAN' },
  { id: 'A-2462', name: 'Marta Ngonga',       program: 'bnac', tipo: 'bolseiro',     stage: 'rejeitado',   score: 54, source: 'Site BFA',     appliedAt: '2026-04-02', course: 'Direito',          uni: 'Lusíada' },
  { id: 'A-2463', name: 'Fátima Makeva',      program: 'vol',  tipo: 'voluntariado', stage: 'triagem',     score: 0,  source: 'Site BFA',     appliedAt: '2026-04-30', course: 'Enfermagem',       uni: 'UCAN' },
  { id: 'A-2464', name: 'Sérvulo Lopes',      program: 'vol',  tipo: 'voluntariado', stage: 'aprovacao',   score: 0,  source: 'LinkedIn',     appliedAt: '2026-04-27', course: '—',               uni: 'Banco BAI' },
]
...
export const eventos: Evento[] = [
  // ── Maio 2026 ──
  {
    ...
    facilitador: 'Edmilson Cardoso',
    vagasTotal: 20,
    inscritos: ['T-1042', 'T-1045', 'T-1048'],
    audiencia: ['estagiario', 'bolseiro'],
    obrigatorio: false,
    programas: ['fbfa', 'lid'],
  },
  {
    ...
    tipo: 'mentoria',
    descricao: 'Sessão colectiva de mentoria para todos os estagiários Futuro BFA — partilha de experiências e desafios.',
    data: '2026-05-12',
    horaInicio: '15:00',
    horaFim: '16:30',
    ...
    facilitador: 'Edmilson Cardoso',
    vagasTotal: null,
    inscritos: ['T-1042', 'T-1045', 'T-1048', 'T-1050'],
    audiencia: ['estagiario'],
    obrigatorio: true,
    programas: ['fbfa'],
  },
  {
    ...
    facilitador: 'Departamento de Compliance BFA',
    vagasTotal: 60,
    inscritos: ['T-1042', 'T-1043', 'T-1044', 'T-1045', 'T-1046', 'T-1048'],
    audiencia: ['todos'],
    obrigatorio: true,
    programas: [],
  },
  {
    ...
    tipo: 'convocatoria',
    descricao: 'Avaliação de desempenho intercalar do 2º trimestre. Presença obrigatória. Duração estimada 45 min por participante.',
    data: '2026-05-19',
    horaInicio: '09:00',
    horaFim: '17:00',
    local: 'Sala de Avaliações — RH, Piso 4',
    facilitador: 'Mariana Quissama (RH)',
    vagasTotal: null,
    inscritos: ['T-1042', 'T-1043', 'T-1044', 'T-1045'],
    audiencia: ['bolseiro', 'estagiario'],
    obrigatorio: true,
    programas: [],
  },
  {
    ...
    facilitador: 'Consultora Externos — Leadership Lab',
    vagasTotal: 15,
    inscritos: ['T-1048', 'T-1058'],
    audiencia: ['bolseiro'],
    obrigatorio: false,
    programas: ['lid', 'mest'],
  },
  {
    ...
    tipo: 'evento',
    descricao: 'Reabilitação de sala de aula e doação de material escolar. Actividade de responsabilidade social.',
    data: '2026-05-24',
    horaInicio: '08:00',
    horaFim: '14:00',
    local: 'Escola Primária nº 47 — Sambizanga, Luanda',
    facilitador: 'Palmira Dala',
    vagasTotal: 30,
    inscritos: ['V-001', 'V-004', 'V-007'],
    audiencia: ['voluntario'],
    obrigatorio: false,
    programas: [],
  },
  {
    ...
    facilitador: 'FinTech Angola Hub',
    vagasTotal: 100,
    inscritos: ['T-1042', 'T-1045', 'T-1048', 'T-1058'],
    audiencia: ['todos'],
    obrigatorio: false,
    programas: [],
  },
  {
    ...
    facilitador: 'Comissão de Avaliação BFA',
    vagasTotal: null,
    inscritos: ['T-1042', 'T-1050'],
    audiencia: ['estagiario'],
    obrigatorio: true,
    programas: ['fbfa'],
  },
  {
    ...
    facilitador: 'Patrícia Lopes',
    vagasTotal: 15,
    inscritos: ['T-1045'],
    audiencia: ['estagiario', 'bolseiro'],
    obrigatorio: false,
    programas: ['fbfa', 'lid', 'bif'],
  },
  {
    id: 'EV-010',
    titulo: 'Sessão de Networking — Alumni BFA',
    tipo: 'evento',
    descricao: 'Jantar de networking com ex-participantes do programa agora funcionários do BFA. Troca de experiências e mentoria informal.',
    data: '2026-06-20',
    horaInicio: '19:00',
    horaFim: '22:00',
    ...
    facilitador: 'RH BFA',
    vagasTotal: 40,
    inscritos: ['T-1042', 'T-1043', 'T-1044', 'T-1045', 'T-1048'],
    audiencia: ['bolseiro', 'estagiario'],
    obrigatorio: false,
    programas: [],
  },
