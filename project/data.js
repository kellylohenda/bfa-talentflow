...
// Tasks assigned to talents by mentors or RH
window.BFA.tasks = [
  { id: 'TK-0001', title: 'Relatório semestral Q1 2026',              talentId: 'T-1042', talentName: 'Lwini Capemba',         assignedBy: 'Edmilson Cardoso',  assignedByRole: 'mentor', category: 'Relatório',    priority: 'alta',  status: 'done',        dueDate: '2026-04-30', completedAt: '2026-04-28', description: 'Submeter relatório de progresso do 1º semestre incluindo avaliação do desempenho académico.' },
  { id: 'TK-0002', title: 'Análise de crédito — caso prático',        talentId: 'T-1042', talentName: 'Lwini Capemba',         assignedBy: 'Edmilson Cardoso',  assignedByRole: 'mentor', category: 'Formação',     priority: 'alta',  status: 'in_progress', dueDate: '2026-05-15', completedAt: null,         description: 'Elaborar análise de crédito de empresa fictícia com demonstrações financeiras fornecidas.' },
  { id: 'TK-0003', title: 'Apresentação à direcção — projecto Q2',    talentId: 'T-1048', talentName: 'Kiala Domingos',        assignedBy: 'Mariana Quissama', assignedByRole: 'rh',     category: 'Apresentação', priority: 'alta',  status: 'pending',     dueDate: '2026-05-20', completedAt: null,         description: 'Preparar apresentação de 10 minutos sobre gestão de carteira de clientes premium.' },
  { id: 'TK-0004', title: 'Boletim académico 2º semestre',             talentId: 'T-1043', talentName: 'Joaquim Tchindemba',   assignedBy: 'Mariana Quissama', assignedByRole: 'rh',     category: 'Documento',   priority: 'média', status: 'pending',     dueDate: '2026-05-31', completedAt: null,         description: 'Submeter boletim de notas do 2º semestre via portal do bolseiro.' },
  { id: 'TK-0005', title: 'Plano de desenvolvimento individual Q3',    talentId: 'T-1045', talentName: 'Yuran Bumba',          assignedBy: 'Patrícia Lopes',   assignedByRole: 'mentor', category: 'PDI',          priority: 'média', status: 'in_progress', dueDate: '2026-05-10', completedAt: null,         description: 'Definir 3 objectivos SMART para o Q3 com competências técnicas e comportamentais.' },
  { id: 'TK-0006', title: 'Relatório de estágio — rotação Banca Privada', talentId: 'T-1048', talentName: 'Kiala Domingos',   assignedBy: 'Edmilson Cardoso',  assignedByRole: 'mentor', category: 'Relatório',    priority: 'alta',  status: 'done',        dueDate: '2026-04-15', completedAt: '2026-04-14', description: 'Relatório de 5 páginas sobre aprendizagens na rotação de Banca Privada.' },
  ...
  { id: 'TK-0008', title: 'Certificação Bloomberg Essentials',          talentId: 'T-1045', talentName: 'Yuran Bumba',          assignedBy: 'Patrícia Lopes',   assignedByRole: 'mentor', category: 'Certificação', priority: 'alta',  status: 'overdue',     dueDate: '2026-04-30', completedAt: null,         description: 'Completar módulos 1-4 da certificação Bloomberg Essentials online.' },
  { id: 'TK-0009', title: 'Relatório semestral Q1 2026',              talentId: 'T-1044', talentName: 'Esperança Quimbamba',  assignedBy: 'Domingos Vieira',  assignedByRole: 'mentor', category: 'Relatório',    priority: 'alta',  status: 'overdue',     dueDate: '2026-04-15', completedAt: null,         description: 'Submeter relatório de progresso do 1º semestre. URGENTE — em atraso há 20 dias.' },
  { id: 'TK-0010', title: 'Workshop "Gestão de Risco Bancário"',       talentId: 'T-1046', talentName: 'Domingas Kassinda',    assignedBy: 'Mariana Quissama', assignedByRole: 'rh',     category: 'Formação',     priority: 'média', status: 'done',        dueDate: '2026-04-20', completedAt: '2026-04-19', description: 'Participar no workshop online e submeter certificado de presença.' },
  { id: 'TK-0011', title: 'Plano de carreira — 3 anos',                talentId: 'T-1058', talentName: 'Alberto Massano',     assignedBy: 'Edmilson Cardoso',  assignedByRole: 'mentor', category: 'PDI',          priority: 'alta',  status: 'pending',     dueDate: '2026-05-25', completedAt: null,         description: 'Definir trajectória de carreira no BFA para os próximos 3 anos após integração.' },
  { id: 'TK-0012', title: 'Reflexão mensal — Abril 2026',              talentId: 'T-1053', talentName: 'Aida Bento',           assignedBy: 'Lina Cazimba',     assignedByRole: 'mentor', category: 'Relatório',    priority: 'baixa', status: 'done',        dueDate: '2026-05-05', completedAt: '2026-05-04', description: 'Submeter reflexão mensal sobre actividades, aprendizagens e desafios de Abril.' },
  ...
  { id: 'TK-0014', title: 'Estudo de caso — Mercado de Capitais',      talentId: 'T-1045', talentName: 'Yuran Bumba',          assignedBy: 'Patrícia Lopes',   assignedByRole: 'mentor', category: 'Formação',     priority: 'média', status: 'pending',     dueDate: '2026-06-10', completedAt: null,         description: 'Analisar e documentar o impacto da digitalização nos mercados de capitais angolanos.' }
];

// Absence requests from talents
window.BFA.absences = [
  ...
  { id: 'FA-005', talentId: 'T-1052', talentName: 'Walter Tchitangueleca',program: 'bnac', type: 'injustificada', reason: '',                                  date: '2026-04-15', days: 1, status: 'rejected', requestedAt: '2026-04-16', approvedBy: 'Domingos Vieira', mentorNote: 'Sem justificação. Terceira falta injustificada.', rhNote: 'Advertência formal emitida.' },
